...
const steps = [
  ...
  },
  {
    ...
    timeline: '5-7 days',
    description:
      'I turn the strategy into conversion copy, mobile-friendly layout, branded sections, and a maintainable website path.',
      ...
      <section className="texture-band neon-deep py-16 md:py-20">
        <div className="container-custom text-center">
          <h2 className="text-3xl font-bebas text-white md:text-5xl">
            Start with the Funnel Review application
          </h2>
