    ...
    <div className="fixed bottom-4 left-4 right-4 z-50 md:hidden">
      <div className="bg-linear-to-r from-purple-900 to-purple-950 border border-orange-500/30 rounded-xl p-3 shadow-glow backdrop-blur-sm">
        <div className="flex items-center justify-between gap-3">
          <Link
            href="#contact"
            className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-linear-to-r from-orange-500 to-orange-600 text-white font-semibold text-sm"
          >
            <Calendar size={16} />
            Book Free Audit
          </Link>
