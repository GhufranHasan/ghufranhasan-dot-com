...
// ── Custom SVG brand icons not available in lucide-react ──────────────────────
...
export default function Contact() {
  ...
  // ── Social links ────────────────────────────────────────────────────────────
  // Replace each href with your real profile URL before going live.
  const socialLinks = [
    {
      label: 'LinkedIn',
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              {[
                { title: 'Free 30-Minute Audit',   sub: "No obligation, just clarity on what's working and what's not" },
            ...
            <motion.div variants={itemVariants}>
              ...
              {/* Wrap so icons flow to a second row on small screens */}
